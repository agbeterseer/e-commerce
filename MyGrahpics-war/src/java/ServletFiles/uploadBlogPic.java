 ...
 */
@WebServlet(name = "uploadBlogPic", urlPatterns = {"/uploadBlogPic"})
public class uploadBlogPic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while (iter.hasNext()) {
          ...
          try {
            ...
            String details = (tmap.containsKey("details")) ? tmap.get("details").toString() : null;
