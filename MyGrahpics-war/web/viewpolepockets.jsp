<%-- 
    Document   : viewpolepockets
    Created on : Dec 1, 2015, 8:07:16 PM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addpolepocket.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Pole Pocket ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Polepocketbean hpp = (Polepocketbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
//                      /  session.setAttribute("p", "viewpolepockets.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hpp.getProductcode()%></td>
    <td><%=hpp.getPolepocketname()%></td>
    <td><%=hpp.getStatus()%></td>
    <td><%=hpp.getPrice()%></td>
    <td><a href="modifyprintedside.jsp?code=<%=hpp.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hpp.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
