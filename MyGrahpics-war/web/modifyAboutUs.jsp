<%-- 
    Document   : modifyAboutUs
    Created on : Nov 22, 2015, 9:30:55 AM
...
<html>
    <head>
        ...
        <title>..::Modify About us::..</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1" name="viewport"/>
<meta content="" name="description"/>
<meta content="Inspiration" name="author"/>
...
<div class="page-container">
    ...
    try{
        ...
        if(request.getParameter("aboutusb") !=null){
        String aboutus =request.getParameter("aboutus");
        String details = request.getParameter("details");
        String visionmission = request.getParameter("visionmission");
        String ourtechnology = request.getParameter("ourtechnology");
        String ourpeople = request.getParameter("ourpeople");
        String ourvision = request.getParameter("ourvision");

//String cardslotname, String productcode, String price, String description, String status
         inl.modifyCardSlot(code, aboutus, ourtechnology, ourpeople, details, visionmission,ourvision);
         msg ="DONE SUCCESSFULY";
       // String abtId, String abtUs, String description, String status, String del
    }
       // String abtId, String abtUs, String description, String status, String del

  
  Cardslotbean hcs = inl.viewSingleCardSlot(code);
    ...
    <form name="form1" method="post" action="">
     <table width="70%" border="0" align="center">
        ...
        <tr>
          <td width="45%"><div align="right">About Us</div></td>
          <td width="55%">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="aboutus" id="aboutus" cols="65" rows="11"> <%=hcs.getCardslotname()%> </textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="details" id="details" cols="65" rows="11"><%=hcs.getDescription()%> </textarea></td>
        </tr>
           <tr>
             <td>Mission</td>
             <td>&nbsp;</td>
           ...
           <tr>
          <td>&nbsp;</td>
          <td><textarea name="visionmission" id="visionmission" cols="65" rows="11"> <%=hcs.getStatus()%> </textarea></td>
        </tr>
           <tr>
             <td>Our Technology</td>
             <td>&nbsp;</td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td><textarea name="ourtechnology" id="ourtechnology" cols="65" rows="11"> <%=hcs.getProductcode()%> </textarea></td>
           </tr>
           <tr>
             <td>Our People</td>
             <td>&nbsp;</td>
           ...
           <tr>
             <td>&nbsp;</td>
             <td><textarea name="ourpeople" id="ourpeople" cols="65" rows="11"> <%=hcs.getPrice()%> </textarea></td>
           </tr>
        <tr>
          <td>
            Our Vision</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="ourvision" id="ourvision" cols="65" rows="11"><%=hcs.getVision()%> </textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><input type="submit" name="aboutusb" id="aboutusb" value="Submit" /></td>
        </tr>
      </table>
</form>
<%}catch(Exception ex){
...
<div class="page-footer">
	<div class="page-footer-inner">
        <%=session.getAttribute("codee").toString()%>2016 &copy; Inspiration.
