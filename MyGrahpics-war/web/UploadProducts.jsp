<%-- 
    Document   : UploadProducts
    Created on : Mar 25, 2016, 2:05:50 PM
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        <form action="" method="post" enctype="multipart/form-data" method="post" action="productsCSV" ><table width="60%" border="0">
  <tr>
  <td>&nbsp;</td>
    <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>UpLoad SCV File</td>
    <td> 
        <input type="submit" name="uploadrecord" id="uploadrecord"  value="Upload"/>
 </td>
    <td>&nbsp;</td>
  </tr>
</table>
