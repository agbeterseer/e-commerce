<%-- 
    Document   : photobook
    Created on : Jan 14, 2016, 4:16:27 AM
...
<%
        ...
        //System.out.println("weee"+hsc.getCode());
                  %>
         ...
         <div class="item active"><a href="photobooks.jsp?code=<%=hsc.getCode()%>"><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                         <p><a href="photobooks.jsp?code=<%=hsc.getCode()%>"> NEXT>>>> Pricing & Order Option </a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
