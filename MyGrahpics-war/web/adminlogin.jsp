    ...
    %>
          <%
            ...
            try{
             ...
             //  String str = inl.setYear(new HelpSetYear("2", "", passport, fileFiled1,""));

         Iterator i = inl.viewAllProducts().iterator();
         while(i.hasNext()){ Productsservicesbean psh = (Productsservicesbean) i.next();
         ...
         session.setAttribute("codee", psh.getProductsId());
            ...
            System.out.println("inside try for Setyear=="+ex.getMessage());
         response.sendRedirect("errorsetup.jsp");
...
String country = request.getParameter("country");
 ...
 String email = request.getParameter("email");
            ...
            if(request.getParameter("addme") !=null && fullname !=null && fullname !="" && country !=null && country !="" && city !=null && city !="" && address !=null && address !="" && email !=null && email !=""){

                try{
                    System.out.println("Add user Time");
                msg = inl.AddUser(username, password, "ADMIN","");
               //String username, String password, String role, String status 
                System.out.println("Add user Time 2");
               style = "success";
                inl.addStaff(username, fullname, "", "", "ADMIN", country, city, "", address, " ", "", null);
                System.out.println("Add user Time 3");
            ...
            if (username != null && username != "" && password != null && password != "" && request.getParameter("loginb") !=null) {

                 System.out.println("username to lowercadse== JSP:" +username);
                System.out.println("password to lowercadse== JSP :" +password);
               ...
               // try {
                ...
                try {
                   ...
                   // inl.userlogin(password, username); 
              //boolean bf = inl.checkUserPassword(username, password);
            mssg = inl.authenticatePassword(username, password);
            
                    if(mssg.equalsIgnoreCase(password)) { 
                     
                              Userbean ush = inl.viewSingleUserRec(username);
                               // msg = "";
                                session.setAttribute("username", username);
                                if (ush.getRole().equalsIgnoreCase("ADMIN")) {
                                   Staffbean sth = inl.viewSingleStaff(username);
                                    stname = sth.getFirstName().toUpperCase() + " " + sth.getLastName().toUpperCase();
 ...
 */
                             ...
                             mssg = "Invalide Username Password !";
...
<html>
    ...
    function checkForm(){
        if ((document.frm.username.value==="")||(document.frm.pass.value==="") ){
            alert("CREDENTIALS NEEDED:You must provide all and valid credentials before you login pls!...");
            return false;
        }
...
<div class="content">
	...
	<form class="login-form" method="post">
		...
		<div class="alert alert-danger display-hide">
			...
			<span>
			<%=mssg%>Enter any username and password. </span>
		</div>
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="remember" value="1"/> Remember me </label>
                    <button type="submit" class="btn green pull-right" name="loginb">
	...
	<form class="forget-form" action="adminlogin.jsp" method="post">
	...
	<form class="register-form" action="adminlogin.jsp" method="post">
		<h3>Sign Up</h3>
		<p>
...
-->
		...
		<div class="form-actions">
			...
			<i class="m-icon-swapleft"></i> Back </button>
			<button type="submit" id="register-submit-btn" class="btn green pull-right" name="addme">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2015 &copy; Inspiration. Admin Dashboard.
</div>
<!-- END COPYRIGHT -->
