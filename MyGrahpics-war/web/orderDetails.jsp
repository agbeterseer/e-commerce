<%-- 
    ...
    Created on : Dec 30, 2015, 12:56:46 PM
    ...
    <td width="89%">  <% 
              ...
              Iterator i = inl.viewAllSubCategorisProductID(code).iterator();
                ...
                <div class="col-md-5 front-carousel" >
                    ...
                    <font size="+1" color="#FF0000"><i>Click on the link to start download Link</i></font>
            </h2> </div>
         <div class="item active"><a href="displayPicture?code=<%=hsc.getCode()%>" download><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
         ...
         <%}}catch(Exception ex){System.out.println();} session.setAttribute("ag", hsc.getCode()); %></td>
    <td width="11%"> </td>
  </tr>
</table>
