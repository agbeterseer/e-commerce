    ...
    <div class="main">
      <div class="container">
       ...
       <li><a href="index.jsp">Home</a></li>
        ...
        <%  try{ Iterator i = inl.viewAllInterioColor().iterator();
                                                        while(i.hasNext()){
       ...
       <div class="form-group">
        ...
        <%  try{ Iterator i = inl.viewAllPrintedSideByProductCode(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("printedside")!=null){
