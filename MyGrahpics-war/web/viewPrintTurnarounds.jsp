<%-- 
    Document   : viewPrintTurnarounds
    Created on : Dec 5, 2015, 8:54:39 AM
...
<html>
    <head>
        ...
        <title>Inspirational Images |view Print Turnarounds</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
      ...
      <%
       ...
       List list = null;
        ...
        try{
            list = inl.viewAllPrintTurnAround();
        }catch(Exception ex){
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addPrintturnaround.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Print Turnaround ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Printturnarroundbean ptah = (Printturnarroundbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        //session.setAttribute("p", "viewGrommets.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=ptah.getProductid()%></td>
    <td><%=ptah.getPrintType()%></td>
    <td><%=ptah.getStatus()%></td>
    <td><%=ptah.getPrice()%></td>
    <td><a href="modifyPrintTurnaround.jsp?code=<%=ptah.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=ptah.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
