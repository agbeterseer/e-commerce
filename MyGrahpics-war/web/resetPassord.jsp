<%-- 
    Document   : resetPassord
    Created on : Nov 21, 2015, 10:23:54 PM
...
if(request.getParameter("modify001") !=null)
{
inl.UserChangePassword(username, password, pass1, "");
msg = "Modified Successfuly!!!";
}
%>

                                            <form action="" method="post" name="changepass" id="form-login" onsubmit="return validate(this);" >
					<table width="80%" border="0" align="center"  >
  <tr>
    <td width="47%"><span style="padding-left:200px;">Old Password&nbsp;</span></td>
    <td width="51%"><span style="padding-left:200px;">
      <input id="Full name" type="password" name="password" class="inputbox compulsory two" alt="username"/>
    </span></td>
    <td width="2%"><%=msg%></td>
  </tr>
  <tr>
    <td><span style="padding-left:200px;">New Password&nbsp;</span></td>
  ...
  <tr>
    <td><span style="padding-left:200px;">Confirm New Password</span></td>
    <td> <div class="fieldWrapper">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>
      <input type="submit" name="modify001" class="art-button" value="Change Password" />
    </td>
    <td>&nbsp;</td>
  </tr>
</table>
