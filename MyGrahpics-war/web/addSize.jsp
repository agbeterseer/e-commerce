<%-- 
    Document   : addSize
    Created on : Nov 14, 2015, 1:32:19 PM
...
<html>
    <head>
        ...
        <title>Inspirational Images | Add Size</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        <%
        String sizetab = request.getParameter("sizetab");
        ...
        String bindinga = request.getParameter("bindinga");
        if(request.getParameter("button") !=null && sizetab !=null && sizetab !=""){
            System.out.println("1" +sizetab);
            System.out.println("2" + status);
            System.out.println("3" + bindinga);
            System.out.println("4" + productsid);
            System.out.println("5"+ startingprice);
            System.out.println("6" + minimumpages);
            System.out.println("7" + pagecost);
            System.out.println("8" + minimumorder);
            System.out.println("9" + bindinga);
          //  System.out.println("did u create?!!!!" + pagecost);
        
                //minimumorder pagecost minimumpages
        try{
               //msg = inl.addSize(sizetab,bindinga,status,productsid,startingprice,pagecost,minimumpages,minimumorder);

               System.out.println("did u create?!!!!");
               //String sizetab, String description, String status, String productcode, String price
               //String pagecost, String minpages, String minorder
            ...
            System.out.println("did u create?!!!!"+ ex.getMessage());
        ...
        %>
                                    ...
                                    <label class="col-md-3 control-label">Size </label>
										<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter size" name="sizetab">
										</div>
                                        </div> 
                                                  <div class="form-group">
                                             <label class="col-md-3 control-label">Price</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter startingprice" name="startingprice" >
                                                </div>
                                                </div>
                                                <div class="form-group">
                                             <label class="col-md-3 control-label">Binding</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter bindings" name="bindinga" >
                                                </div>
                                                </div>
                                             ...
                                             <label class="col-md-3 control-label">Minimum Pages</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter Minimum Pages" name="minimumpages" >
                                                </div>
                                                </div>
                                                       <div class="form-group">
                                             <label class="col-md-3 control-label">Page Cost</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter Page Cost" name="pagecost" >
                                                </div>
                                                </div>
                                                  <div class="form-group">
                                             <label class="col-md-3 control-label">Minimum Order</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter Minmum Order" name="minimumorder" >
                                                </div>
                                                </div>
