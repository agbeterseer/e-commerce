<%-- 
    Document   : viewInteriocolor
    Created on : Dec 2, 2015, 6:26:42 PM
...
<html>
    <head>
        ...
        <title>view Interior color</title>
...
<div class="page-container">
  ...
  //      if(request.getParameter("button") !=null){
    ...
    <tr>
        <td><a href="viewIteriorColors.jsp">Pervious</a></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><a href="modifyInteriorcolor.jsp">Modify</a></td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    <td>Product ID</td>
    <td><span class="form-body">
      <select name="productsid" id="productsid" disabled >
        <option value=" "><%=hc.getProductcode()%></option>
      </select>
    </span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td width="34%">&nbsp;</td>
    <td width="18%">Perforation</td>
    <td width="27%"><label>
      <input type="text" name="perforation" id="perforation" value="<%=hc.getInteriorcolorname()%>">
    </label></td>
    <td width="21%">&nbsp;</td>
  </tr>
  <tr>
