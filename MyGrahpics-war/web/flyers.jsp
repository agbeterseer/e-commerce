<%-- 
    Document   : flyers
    Created on : May 13, 2016, 3:44:00 PM
          ...
          <div class="col-md-12 col-sm-12">
            <div class="row margin-bottom-30">
              ...
              // System.out.println("code inside startcalculate==" + code);
               //System.out.println("flyer inside startcalculate==" + flyer);
            ...
            <div class="portlet-body form">
               <form class="form-horizontal"   action=""  method="post"  onsubmit="return validate(this);">
                  <% if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayer()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayers()) ){ %>
                <div class="form-body">
          ...
          String gsf = new Integer(sumb).toString();
            ...
            %>
                      ...
                      <div class="pi-price" style="background-color:maroon; color:white">N<%=sumb%>.00</div><br/>
                          <a href="login.jsp?code=<%=code%>" class="btn btn-default add2cart">Add to cart</a>
         <%
          }else{
