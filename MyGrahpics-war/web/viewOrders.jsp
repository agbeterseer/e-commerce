<%-- 
    Document   : viewOrders
    Created on : Dec 5, 2015, 11:51:56 AM
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
      ...
      <%
       ...
       List list = null;
        try{
            list = inl.viewAllDeliveryAddress();
        }catch(Exception ex){
...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..Orders ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Deliverydetailsbean hd = (Deliverydetailsbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                       //   HelpInitializeProducts hlpsession.setAttribute("p", "viewFoldings.jsp");
  %>
  <tr class="<%=style%>">
      <td height="28" class="tab_lebel"><%=inl.viewSingleSubcategory(inl.viewSingleBilling(hd.getUsername()).getProductid()).getSubcategory()%></td>
    <td><%=hd.getFirstname() +" -- " + hd.getLastname()%></td>
    <td><%=hd.getTelephone()%></td>
    <td><%=hd.getEmail()%></td>
    <td><a href="orderDetails.jsp?code=<%=inl.viewSingleBilling(hd.getUsername()).getProductid()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hd.getUsername()%>">   </td>
    </tr>
   <%
	count++;
  }
