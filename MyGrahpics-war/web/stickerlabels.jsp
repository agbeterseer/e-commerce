...
s</h2></div>
    ...
    <%
 if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLebels_Stickers())){%>
<div class="form-group">
...
//size pages papertype
    ...
    // String productcode, String printedside, String papertype, String Quantity
        //computeBusinessCard(String productcode, String printedside, String papertype, String Quantity)
          sumb = inl.computeStickerLabels(session.getAttribute("ag").toString(), size, papertype, Quantity);
