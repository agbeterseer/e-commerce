...
try{ 
         ...
         <div class="item active"><a href="stickerlabels.jsp?code=<%=hsc.getCode()%>"><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                          <p> <a href="stickerlabels.jsp?code=<%=hsc.getCode()%>" style="color:white" > NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
