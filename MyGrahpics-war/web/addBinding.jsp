<%-- 
    Document   : addBinding
    Created on : Dec 4, 2015, 3:47:21 PM
...
<div class="page-container">
   ...
   <%
        ...
        try{
          inl.addBinding("",nlocation, status, startingprice, productsid);
          //String bindingId, String bindingName, String description, String price, String productid
          
            msg = "DONE SUCCESSFULY";
           //String bindingName, String description, String status, String del, String price, String productid
 ...
 <div class="portlet-body form">
     <%=msg%>
        ...
        %>
										...
										* </span></label>
                                                <div class="col-md-9">
                                                    <input type="text" name="nlocation" id="Binding" placeholder="Enter Binding" value="">
