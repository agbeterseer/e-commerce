<%-- 
    Document   : viewpapertypes
    Created on : Dec 1, 2015, 3:24:15 PM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addPaperType.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Paper Type ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Papertypebean pthh = (Papertypebean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        session.setAttribute("p", "viewpapertypes.jsp");
  %>
  <tr class="<%=style%>">
      <td height="28" class="tab_lebel"><%=(inl.viewSingleSubcategory(pthh.getProductName())).getSubcategory()%></td>
    <td><%=pthh.getPaperName()%></td>
    <td><%=pthh.getStatus()%></td>
    <td><%=pthh.getPrice()%></td>
    <td><a href="modifyPaperType.jsp?code=<%=pthh.getPaperTypeId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=pthh.getPaperTypeId()%>">   </td>
    </tr>
   <%
	count++;
  }
...
<div class="page-footer">
	<div class="page-footer-inner">
		<%=session.getAttribute("codee").toString()%> &copy; Inspiration.
	</div>
