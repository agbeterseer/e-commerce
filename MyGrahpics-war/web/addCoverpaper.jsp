<%-- 
    Document   : addCoverpaper
    Created on : Dec 4, 2015, 2:33:09 PM
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
     ...
     <%
        ...
        try{
            inl.addCoverPaper("",nlocation, startingprice, productsid);
//String cpId, String cpName, String description, String productid
  ...
  <td>&nbsp;</td>
    <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><a href="viewcoverpapers.jsp"> Previous </a></td>
  </tr>
  <tr>
  ...
  <tr><div class="form-group">
    <td>&nbsp;</td>
    <td>	<label class="col-md-3 control-label">Product ID<span class="required">
										* </span></label></td>
    <td>
  ...
  <tr>
    ...
    <td width="46%">
      <input type="text" name="nlocation" id="nlocation" value="">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
