...
try{
 ...
 if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getIDCards()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLUAGAGE_AGS())){
response.sendRedirect("idcard.jsp");
session.setAttribute("code", code);
   }
if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPasport_Photos())){
response.sendRedirect("passportPhoto.jsp");
session.setAttribute("code", code);
}
if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBusiness_Card())){
    response.sendRedirect("Businesscard.jsp");
session.setAttribute("code", code);
    }else{
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post">
                                    <div class="form-group">
										...
										<div class="col-md-4">
						 2 STEPS TO CALCULATE YOUR ORDER
										</div>
									</div>
<%
 if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCD_Covers_Inlays()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getWindow_graphics()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getMOUSE_pad()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getMOUSE_pads()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPens()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPen()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getKey_chains()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getWater_Bottles()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCoaster())  || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCoasters()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPhone_cases())  || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getJERSEYS())  || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGift_Certificate()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getName_badge()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getName_badges()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBEERMUG()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBEERMUGwithgoldring()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFrosted()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNormalwhitemug()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getTwotone()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getColourchangingmug()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGoldmug()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCalenders())){
%>
...
//size pages papertype
    ...
    if( request.getParameter("Quantity")!=null ){
       // System.out.println("pass this line now please===" + Quantity);
//String price, String productcode

          sumb = inl.computeCDLayers(session.getAttribute("ag").toString(), Quantity);
         ...
         <%
                ...
                //System.out.println("size size=="+ hsc.getDefaultprice());
              //  System.out.println("size size=="+ hsc.getSize());
          // sumb = inl.viewSingleSiz    eGet(session.getAttribute("ag").toString());
                //session.setAttribute("price", hsc.getDefaultprice());
...
<%}catch(Exception ex){System.out.println();}%>
          ...
          <!-- END SAMPLE FORM PORTLET-->
                ...
                <div class="col-md-7">
                    <h3>For custom size please contact us at</h3>

   <font size="+1" color="red" >info@inspirationalimagesltd.com</font>
