<%-- 
    Document   : modifyQuantity
    Created on : Dec 18, 2015, 6:32:24 AM
...
<html>
    <head>
        ...
        <title>Inspirational Images | modify Quantity</title>
...
<div class="page-container">
    ...
    <%
     String  code = request.getParameter("code");
        ...
        String productsid2 = request.getParameter("productsid2");
        String quantity = request.getParameter("quantity");

        try{
           msg = inl.modifyQuantity(code,quantity,productsid2,productsid);
       ...
       try{
      Quantitybean hq = inl.veiwSingleQuantity(code);
       // if(){
        %>
  ...
  <tr>
    ...
    <td><span class="form-body">
      <select name="productsid" id="productsid" >
        <option value="<%=hq.getProductcode()%>"><%=hq.getProductcode()%></option>
  ...
  <tr>
    ...
    <td>Quantity</td>
    <td><label>
    <input type="text" name="quantity" id="quantity" value="<%=hq.getQty()%>" >
    </label> </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><label>
     <select name="status" id="status">
               <option value="<%=hq.getStatus()%>"><%=hq.getStatus()%></option>
