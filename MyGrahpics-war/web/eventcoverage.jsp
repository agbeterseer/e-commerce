<%-- 
    Document   : eventcoverage
    Created on : Jan 14, 2016, 5:55:07 AM
...
<%
         ...
         <div class="item active"><a href="eventcoverages.jsp?code=<%=hsc.getCode()%>"><img alt="Inspirational" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                         <p><a href="eventcoverages.jsp?code=<%=hsc.getCode()%>"> NEXT>>>> Pricing & Order Option </a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
