<%-- 
    Document   : viewprintedsides
    Created on : Dec 1, 2015, 7:46:51 PM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addprintside.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Printed Side ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                      Printedsidebean hps = (Printedsidebean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                       // session.setAttribute("p", "viewprintedsides.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hps.getProductid()%></td>
    <td><%=hps.getPrintedsidename()%></td>
    <td><%=hps.getStatus()%></td>
    <td><%=hps.getPrice()%></td>
    <td><a href="modifyprintedside.jsp?code=<%=hps.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hps.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
