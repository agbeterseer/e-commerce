<%-- 
    Document   : eventcoverages
    Created on : Jan 14, 2016, 5:59:29 AM
         ...
         <div class="item active"> <img alt="" src="displayPicture?code=<%=hsc.getCode()%>">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post">
                  ...
                  %>
<%
 if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEvent_coverages())){
%>
<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-5">
										<select class="form-control" name="size"  style="width:200px;" onchange="this.form.submit();" >

        <%  try{ Iterator i = inl.viewBYPolePocketCODE(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 hpp = (Polepocketbean) i.next();
        %>
        <option value="<%=hpp.getId()%>"<%=request.getParameter("size") != null && request.getParameter("size").equalsIgnoreCase(hpp.getId()) ? new String("selected") : new String("")%>><%=hpp.getPolepocketname()%></option>
        <%                                            }
     ...
     String size = request.getParameter("size");
        ...
        try{
            session.setAttribute("Quantity", strims);
            ...
            session.setAttribute("size", inl.viewSinglePolePocket(hpp.getId()).getPolepocketname());
...
//size pages papertype
    ...
    if( request.getParameter("size")!=null ){
       // System.out.println("pass this line now please===" + hq.getDescription());
          ...
          sumb = inl.viewSingleSizeEvent(size, hsc.getDefaultprice(), hq.getDescription());

          String gsf = new Integer(sumb).toString();
           // session.setAttribute("price", gsf);
            %>
                      <div class="pi-price">N<%=sumb%></div>
         ...
         %>
 <div class="pi-price"  >N<%=hsc.getDefaultprice()%></div>
