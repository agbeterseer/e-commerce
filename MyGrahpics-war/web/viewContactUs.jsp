<%-- 
    Document   : viewContactUs
    Created on : Nov 22, 2015, 10:39:49 AM
...
<html>
    <head>
        ...
        <title>Inspiration |Contact Us</title>
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addContact.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Contacts ..</td>
    </tr>
</table>
<table width="80%" border="0" cellspacing="0" cellpadding="0" id="results">
  <tr class="tableheader">
    <td width="28%" height="20"><strong>Address</strong></td>
    <td width="20%">&nbsp;</td>
    <td width="30%">&nbsp;</td>
    <td width="30%">&nbsp;</td>
  ...
  %>
  <tr class="<%=style%>">
    <td height="28" colspan="4" class="tab_lebel"><%=hr.getHermsname()%></td>
    <td><a href="modifyContactus.jsp?code=<%=hr.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hr.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
