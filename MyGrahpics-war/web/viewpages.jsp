<%-- 
    Document   : viewpages
    Created on : Dec 1, 2015, 3:31:39 PM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addPages.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Pages ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Pagestabbean pth = (Pagestabbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        //session.setAttribute("p", "viewpages.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=pth.getProductid()%></td>
    <td><%=pth.getPageNumber()%></td>
    <td><%=pth.getStatus()%></td>
    <td><%=pth.getPrice()%></td>
    <td><a href="modifypage.jsp?code=<%=pth.getPageId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=pth.getPageId()%>">   </td>
    </tr>
   <%
	count++;
  }
