            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post">
						 ...
						 2 STEPS TO CALCULATE YOUR ORDER
                            ...
                            <%
 if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLetterhead_Stattionary()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEvent_Tickets())){
                            %>
 <div class="form-group">
        ...
        <%  try{                    List listi= null;
                             listi = inl.viewAllQuatityBydescription(hsc.getCode());
                                    Iterator i = listi.iterator();
                                                        while(i.hasNext()){
                           //   UserHelper ush = null; HelpQuantity hq
...
<div class="form-group">
     ...
     String printedsize = request.getParameter("printedsize");
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if( request.getParameter("Quantity")!=null || request.getParameter("size") !=null || request.getParameter("papertype") !=null){
       // System.out.println("pass this line now please===" + hq.getDescription());
    // computeLetterHead(String size, String papertype, String Quantity, String productcode)
          sumb = inl.computeLetterHead(size, papertype, Quantity, session.getAttribute("ag").toString());
  ...
  <% try{
    ...
    %>
        ...
        <div class="col-md-3 col-sm-6 pre-footer-col">
            ...
            <%=hr.getHermsname()%><br>
                  <%=hr.getDesceiption()%><br>
              <%=hr.getStatus()%>  <%=hr.getFax()%><br>
