...
try{
   ...
   if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEnvelops()) ){
response.sendRedirect("envelops.jsp");
session.setAttribute("code", code);
   }else{
       if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCanvas_Printing())){

 response.sendRedirect("canvasprinting.jsp");
session.setAttribute("code", code);

       }
       
        if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGreeting_Cards())){

 response.sendRedirect("greetingcards.jsp");
session.setAttribute("code", code);

       }
       
       if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pad()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pads())){

                response.sendRedirect("notepads.jsp");
                session.setAttribute("code", code);
      }
       if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBrochure()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCataloge())){

 response.sendRedirect("Brochure.jsp");
session.setAttribute("code", code);

       }
       
  if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEercise_book())){

 response.sendRedirect("excercisebook.jsp");
session.setAttribute("code", code);
...
if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getRoll_up_Banners()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getRoll_up_Banner()) ){
          response.sendRedirect("rollupbanner.jsp");
            session.setAttribute("code", code);
          }
       if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLetterhead_Stattionary()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEvent_Tickets()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLebels_Stickers())){
        response.sendRedirect("productsp.jsp");
        session.setAttribute("code", code);

       }

      }
   if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayers()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayer())){
          response.sendRedirect("flyers.jsp");
            session.setAttribute("code", code);
          }else{
          //}
      ...
      <div class="container">
       ...
       <li><a href="products.jsp"> Products</a></li><li class="active">  <%=inl.viewSingleSubcategory(code).getSubcategory()%></li>
          ...
          <div class="col-md-12 col-sm-12">
            <div class="row margin-bottom-30">
              ...
              hsc = inl.viewSingleSubcategory(srt);
                ...
                <div class="col-md-5 front-carousel" >
                    <div class="carousel slide" id="myCarousel"> <form action="" method="get" enctype="multipart/form-data">
                    <!-- Carousel items -->
                    ...
                    <div class="item active"> <img alt="" src="displayPicture?code=<%=code%>">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post"  onsubmit="return validate(this);">
                  <% if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBooklets()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGreeting_Cards()) ){ %>
                <div class="form-body">
                                            <div class="form-group">
										<label class="control-label col-md-3">Size <span class="required">
										* </span>
										</label>
										<div class="col-md-5">
				<select class="form-control" name="size" onChange="this.form.submit();" style="width:200px;"  >
                                    
        <%  try{ Iterator i = inl.viewBYPolePocketCODE(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                Polepocketbean hpp = (Polepocketbean) i.next();
        %>
        <option value="<%=hpp.getPolepocketname()%>"<%=request.getParameter("size") != null && request.getParameter("size").equalsIgnoreCase(hpp.getPolepocketname()) ? new String("selected") : new String("")%>><%=hpp.getPolepocketname()%></option>
        <%                                            }
        ...
        %>
                                                        ...
                                                        <div class="form-group">
										<label class="control-label col-md-3">Pages <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control" name="pages" onchange="this.form.submit();" style="width:200px;">

        <%  try{ Iterator i = inl.viewAllPagesByProductid(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 Pagestabbean pth = (Pagestabbean) i.next();
           %>
        <option value="<%=pth.getPageNumber()%>"<%=request.getParameter("pages") != null && request.getParameter("pages").equalsIgnoreCase(pth.getPageNumber()) ? new String("selected") : new String("")%>><%=pth.getPagename()%></option>
        <%                                            }
        ...
        <%  try{ 
            Iterator i = inl.viewAllPaperTypeByProductName(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 Papertypebean pthh = (Papertypebean) i.next();
           %>
        <option value="<%=pthh.getPaperName()%>"<%=request.getParameter("papertype") != null && request.getParameter("papertype").equalsIgnoreCase(pthh.getPaperName()) ? new String("selected") : new String("")%>><%=pthh.getPaperName()%></option>
        <%                                            }
        ...
        %>
                                                 ...
                                                 <div class="form-group">
										<label class="control-label col-md-3">Binding  <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									<select class="form-control" name="binding" onchange="this.form.submit();" style="width:200px;">

        <%  try{ 
            Iterator i = inl.viewAllBindingProductId(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 Bindingbean bh = (Bindingbean) i.next();
           %>
        <option value="<%=bh.getBindingName()%>"<%=request.getParameter("binding") != null && request.getParameter("binding").equalsIgnoreCase(bh.getBindingName()) ? new String("selected") : new String("")%>><%=bh.getBindingName()%></option>
        <%                                            }
        ...
        %>
                     ...
                     <div class="form-group">
										<label class="control-label col-md-3">Bind Placement <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									<select class="form-control" name="bindingplacement" onchange="this.form.submit();" style="width:200px;">

        <%  try{ Iterator i = inl.viewAllBindPlacement().iterator();
                                                        while(i.hasNext()){
                                                Bindpalcementbean hbp = (Bindpalcementbean) i.next();
           %>
        <option value="<%=hbp.getBpId()%>"<%=request.getParameter("bindingplacement") != null && request.getParameter("bindingplacement").equalsIgnoreCase(hbp.getBpId()) ? new String("selected") : new String("")%>><%=hbp.getBpName()%></option>
        <%                                            }
                                                      }catch(Exception ex){
                                                System.out.println(ex.getMessage());
                                                      }
        %>
                  ...
                  <div class="form-group">
										<label class="control-label col-md-3">Cover Paper <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control" name="coverpaper" onchange="this.form.submit();" style="width:200px;">

        <%  try{ 
            Iterator i = inl.viewAllCoverPaperByProductId(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 Coverpaperbean cph = (Coverpaperbean) i.next();
           %>
        <option value="<%=cph.getCpName()%>"<%=request.getParameter("coverpaper") != null && request.getParameter("coverpaper").equalsIgnoreCase(cph.getCpName()) ? new String("selected") : new String("")%>><%=cph.getCpName()%></option>
        <%                                            }
                                                      }catch(Exception ex){
                                                System.out.println(ex.getMessage());
                                                      }
        %>
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">Print Turnaround<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control" name="printturnaround" onchange="this.form.submit();" style="width:200px;">

        <%  try{ Iterator i = inl.viewAllPrintTurnAround().iterator();
                                                        while(i.hasNext()){
                                                 Printturnarroundbean ptah = (Printturnarroundbean) i.next();
           %>
        <option value="<%=ptah.getId()%>"<%=request.getParameter("printturnaround") != null && request.getParameter("printturnaround").equalsIgnoreCase(ptah.getId()) ? new String("selected") : new String("")%>><%=ptah.getPrintType()%></option>
        <%                                            }
                                                      }catch(Exception ex){
                                                System.out.println(ex.getMessage());
                                                      }
...
<%}else { 
              ...
              session.setAttribute("code", hsc.getCode());
        ...
        <%  try{                
                 ...
                 Iterator i = inl.viewAllQuatityBydescription(hsc.getCode()).iterator();
                                        while(i.hasNext()){ hq = (Quantitybean) i.next();
        %>
     ...
     String printturnaround = request.getParameter("printturnaround");
        ...
        try{
            ...
            session.setAttribute("ag", code);
             ...
             session.setAttribute("page", "shop-shopping-cart.jsp");
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("pages")!=null){
       // System.out.println("pass this line now please===" + hq.getDescription());


          sumb = inl.viewSingleSize2(size, pages, Quantity, hsc.getDefaultprice(), hq.getDescription(), session.getAttribute("ag").toString(), binding);
          ...
          String gsf = new Integer(sumb).toString();
            ...
            %>
                      ...
                      <div class="pi-price" style="background-color:maroon; color:white">N<%=sumb%>.00</div><br/>
                          <a href="login.jsp" class="btn btn-default add2cart">Add to cart</a>
         <%
          }else{
...
at 234-8095434402,234-8095434425 for assistance.</div>
                  <br>
