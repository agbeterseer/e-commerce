...
<%
if( hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getHome_services()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEvent_coverages()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getStudio_shots_model_shots()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getSchool_bag()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getWindow_graphics()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCustomisation_of_T_shirts()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCustomisation_of_T_shirt())|| hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPosters_banners_and_stickers()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPhoto_printing()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPhoto_frames()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getConference_bag()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPasport_Photos()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGift_Certificate())){
%>
...
<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-5">
										<select class="form-control" name="sizes" onChange="this.form.submit();" style="width:200px;"  >
                                                                                    <option value="">...select one...</option>
     <%  try{ Iterator i = inl.viewBYPolePocketCODE(hsc.getCode()).iterator();
                                                        while(i.hasNext()){
                                                Polepocketbean hpp = (Polepocketbean) i.next();
        %>
        <option value="<%=hpp.getPolepocketname()%>"<%=request.getParameter("sizes") != null && request.getParameter("sizes").equalsIgnoreCase(hpp.getPolepocketname()) ? new String("selected") : new String("")%>><%=hpp.getPolepocketname()%></option>
        <%                                            }
      ...
      <%  try{                   
                             Iterator i  = inl.viewAllQuatityBydescription(hsc.getCode()).iterator();
                              while(i.hasNext()){
                             Quantitybean hq = (Quantitybean) i.next();
           %>
...
<label class="control-label col-md-3"> Estimated Total:<span class="required">
     ...
     String printturnaround = request.getParameter("printturnaround");
        ...
        try{
            ...
            session.setAttribute("size", sizes);
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if(request.getParameter("sizes")!=null || request.getParameter("Quantity")!=null ){
     //   System.out.println("pass this line now please===" + hq.getDescription());

//computeIDCard(String qty, String size, String productcode)
          sumb = inl.computeLuagageTag(Quantity, sizes, hsc.getCode());
