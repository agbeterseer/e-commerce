<%-- 
    Document   : addContact
    Created on : Nov 22, 2015, 9:52:09 AM
...
<html>
    <head>
        ...
        <title>Inspiration |Add Contact</title>
...
<div class="page-container">
    ...
    try{
        ...
        inl.addHerms("",contactus, tellphone, states, city, street, email, fax, country, skype);
      ...
      <table width="70%" border="0" align="center">
        ...
        <tr>
         ...
         <tr>
          ...
          <td><textarea name="contactus" id="contactus" cols="65" rows="11"> </textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="states" id="states"></td>
        </tr>
         <tr>
          <td width="45%"><div align="right">Town</div></td>
          <td width="55%"><input type="text" name="fax" id="fax"></td>
        </tr>
        <tr>
