...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if( request.getParameter("Quantity")!=null || request.getParameter("printedside") !=null || request.getParameter("papertype") !=null){
      
          sumb = inl.computeBusinessCard(session.getAttribute("ag").toString(), printedside, papertype, Quantity);
