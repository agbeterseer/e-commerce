...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
 ...
 <%@include file="lookupa.jsp" %>
   <% String code = request.getParameter("lookfor"); 
...
<html>
    <head>
        ...
        <title>Inspirational Images Ltd</title>
...
<div class="col-md-6 col-sm-6 additional-nav">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12"> 
            <div class="row margin-bottom-30">
                ...
                <div class="col-md-6">
                  <form action="shop-search-result.jsp">
                    <div class="input-group">
                        <input type="text" placeholder="Search again" class="form-control" name="nowsearch">
  ...
  <% 
               try{
                   String nowsearch = request.getParameter("nowsearch");
                    List list = null; 
                   list = inl.searchBySubCategory(code);
                   if(nowsearch !=null){ 
                   list = inl.searchBySubCategory(nowsearch);
                   }
         ...
         if(list.isEmpty() ){
                  %>
           <font size="+1" color="#FF0000"><i>No Record Found(s)!!!!!</i></font><br/>
                  <%}else{%>
           ...
           <div class="col-md-5 front-carousel" >
                    ...
                    <div class="item active"><a href="<%=inl.viewSingleInitial(hsc.getProductId()).getDefaultpage()%>?code=<%=hsc.getCode()%>"> <img alt="" src="displayPicture?code=<%=hsc.getCode()%>"></a>
                  <div class="carousel-caption">
                          <p><a href="<%=inl.viewSingleInitial(hsc.getProductId()).getDefaultpage()%>?code=<%=hsc.getCode()%>" style="color:white" > NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
