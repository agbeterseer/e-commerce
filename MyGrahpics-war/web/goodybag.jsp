...
<html>
    <head>
        ...
        <title>Inspirational Images | Goody Bag</title>
        ...
        %>
                                      ...
                                      <div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											 <select class="form-control" name="lamination" onchange="this.form.submit();" style="width:200px;">

        <%  try{ Iterator i = inl.viewAllLaminationProductCode(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                 Laminationbean hl = (Laminationbean) i.next();
           %>
        <option value="<%=hl.getLaminate()%>"<%=request.getParameter("lamination") != null && request.getParameter("lamination").equalsIgnoreCase(hl.getLaminate()) ? new String("selected") : new String("")%>><%=hl.getLaminate()%></option>
        <%                                            }
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if( request.getParameter("Quantity")!=null || request.getParameter("size") !=null || request.getParameter("lamination") !=null){
        //System.out.println("pass this line now please===" + hq.getDescription());
    // computeGoodyBag(String size, String qty, String productcode, String lamination)
          sumb = inl.computeGoodyBag(size, Quantity, session.getAttribute("ag").toString(), lamination);
