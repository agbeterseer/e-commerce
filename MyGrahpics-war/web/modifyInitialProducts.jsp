<%-- 
    Document   : modifyInitialProducts
    Created on : Dec 6, 2015, 1:40:49 PM
...
<html>
    <head>
        ...
        <title>Inspiration |modify Initial Products</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        if(request.getParameter("inite")!=null){
        String productname = request.getParameter("productname");
        String defaultlink = request.getParameter("defaultlink");
        String defaultprice = request.getParameter("defaultprice");
        String status = request.getParameter("status");
        try{
        inl.modifyInitialzeProducts(productname, status, defaultprice, defaultlink);
        response.sendRedirect("seeAllData.jsp");
        ...
        try{
         Initializeprodutsbean  hlp = inl.viewSingleInitial(code);
        %>
  ...
  <tr>
    <td>Product Name</td>
    <td><input type="text" name="productname" id="productname" value="<%=hlp.getProductName()%>"></td>
  </tr>
  <tr>
    <td>Default link</td>
    <td><input type="text" name="defaultlink" id="defaultlink" value="<%=hlp.getDefaultpage()%>"></td>
  </tr>
  <tr>
    <td>Default Price</td>
    <td><input type="text" name="defaultprice" id="defaultprice" value="<%=hlp.getProductDefaultPrice()%>"></td>
  </tr>
  <tr>
    <td>Status</td>
    <td><select name="status" id="status">
        <option value="<%=hlp.getProductStatus()%>"><%=hlp.getProductStatus()%></option>
      <option value="ENABLE">ENABLE</option>
      <option value="DISABLE">DISABLE</option>
    </select>    </td>
  </tr>
  <tr>
    <td><input type="submit" name="inite" id="inite" value="Submit"></td>
    <td>&nbsp;</td>
  </tr>
</table>
</form>
