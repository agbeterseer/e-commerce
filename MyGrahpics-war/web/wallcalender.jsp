      ...
      <div class="container">
       ...
       <li><a href="products.jsp"> Products</a></li><li class="active">  <%=inl.viewSingleSubcategory(code).getSubcategory()%></li>
         ...
         <div class="item active"> <img alt="" src="displayPicture?code=<%=hsc.getCode()%>">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post"  onsubmit="return validate(this);">
                  <% if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCalender()) ){ %>
                <div class="form-body">
        ...
        %>
                  ...
                  <div class="form-group">
										<label class="control-label col-md-3">Lamination <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
...
//size pages papertype coverpaper quantity
         float sum = 0.0F;
       float total = 0.0F;
       int sumb = 0;
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("pages")!=null){
        //System.out.println("pass this line now please===" + hq.getDescription());
            ...
            sumb = inl.claculateCalender(pages, session.getAttribute("ag").toString(), Quantity, size);
            //grommetname AND g.productcode = :productcode AND g.status = :status AND g.size1 = :size1
          //sumb = inl.claculateCalender(size, pages, papertype, coverpaper, Quantity, session.getAttribute("ag").toString());
