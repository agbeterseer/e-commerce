<%-- 
    Document   : photobooks
    Created on : Jan 14, 2016, 4:20:03 AM
...
ND NAVIGATION -->
    ...
    <div class="main">
      <div class="container">
       <ul class="breadcrumb"> 
       <li><a href="index.jsp">Home</a></li>
       <li><a href="begincat.jsp"> Products</a></li>
       <li  class="active"> <%=inl.viewSingleSubcategory(code).getSubcategory()%></li>
...
<%
if(hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getPhoto_Books()) ){
%>
...
<div class="form-group">
        ...
        %>
										...
										* </span>
										...
										<div class="col-md-4">
											 <select class="form-control" name="papertype"   style="width:200px;">
        ...
        %>
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3">Sheets <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
...
//size pages papertype
    ...
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null){
       // System.out.println("pass this line now please===" + hq.getDescription());
          ...
          sumb = inl.viewSingleSizePhotoBook(size, Quantity, session.getAttribute("ag").toString());

          String gsf = new Integer(sumb).toString();
            session.setAttribute("price", gsf);
            %>
                      <div class="pi-price" style="background-color:maroon; color:white">N<%=sumb%>.00</div>
 ...
 <div class="pi-price" style="background-color:maroon; color:white">N<%=hsc.getDefaultprice()%>.00</div>
