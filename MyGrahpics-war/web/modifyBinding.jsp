<%-- 
    Document   : modifyBinding
    Created on : Dec 4, 2015, 3:57:10 PM
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <title>Inspiration Images |add Binding</title>
...
<div class="page-container">
   ...
   try{
        ...
        String startingprice = request.getParameter("startingprice");
            ...
            inl.modifyBinding(code, nlocation, description, startingprice, productsid);
            //String bpId, String bpName, String description, String price, String productid
           response.sendRedirect("viewBindings.jsp");
      ...
      Bindingbean bh = inl.viewSingleBinding(code);
       ...
       <div class="portlet-body form">
        <form action="" method="post" class="form-horizontal" role="form" onsubmit="return validate(this);">
            <div class="form-body"><a href="viewBindings.jsp">Previous</a>
                              <div class="form-group">
										<label class="col-md-3 control-label">Product ID<span class="required">
										* </span></label>
										<div class="col-md-9">
											<select class="form-control" name="productsid">
                                                 <option value="<%=bh.getProductid()%> "><%=bh.getProductid()%></option>
        ...
        %>
                                            ...
                                            <div class="form-group">
                                             <label class="col-md-3 control-label">Binding<span class="required">
										* </span></label>
                                                <div class="col-md-9">
                                                    <input type="text" name="nlocation" id="Binding" placeholder="Enter Binding" value="<%=bh.getBindingName()%>">
                                             ...
                                             <label class="col-md-3 control-label">Starting Price</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter startingprice" name="startingprice" value="<%=bh.getPrice()%>">
                                                </div>
                                                </div>
                                            <div class="form-group">
                                             <label class="col-md-3 control-label">Status</label>
                     <div class="col-md-9"><select name="status" id="status" class="form-control">
          <option value=" <%=bh.getStatus()%>"><%=bh.getStatus()%> </option>
