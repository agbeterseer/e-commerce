...
<%
         ...
         <div class="item active"><a href="wallcalender.jsp?code=<%=hsc.getCode()%>"><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                          <p> <a href="wallcalender.jsp?code=<%=hsc.getCode()%>" style="color:white" > NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
         ...
         <%}}catch(Exception ex){System.out.println();} session.setAttribute("ag", hsc.getCode()); %>
                ...
                <div class="col-md-7">
                 ...
                 <strong> @ +234 80954334402, 234 8095434425 for assistance.</strong></p></font>
                  <br>
