...
<html>
    <head>
        ...
        <title>Inspirational Images | envelops</title>
      ...
      <div class="container">
       ...
       <li><a href="index.jsp">Home</a></li>
        ...
        <div class="row margin-bottom-40">
         ...
         <div class="item active"> <img alt="Inspirational" src="displayPicture?code=<%=hsc.getCode()%>">
        ...
        %>
										...
										* </span>
										...
										<div class="col-md-5">
										<select class="form-control" name="colorin" onChange="this.form.submit();" style="width:200px;"  >
                                        
        <%  try{ Iterator i = inl.viewAllInterioColorByProductCode(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
                                                Interiorcolorbean hc = (Interiorcolorbean) i.next();
        %>
        <option value="<%=hc.getInteriorcolorname()%>"<%=request.getParameter("colorin") != null && request.getParameter("colorin").equalsIgnoreCase(hc.getInteriorcolorname()) ? new String("selected") : new String("")%>><%=hc.getInteriorcolorname()%></option>
        <%                                            }
        ...
        %>
                                                    ...
                                                    <div class="form-group">
										<label class="control-label col-md-3">Printed Side <span class="required">
										* </span>
										</label>
										<div class="col-md-5">
										<select class="form-control" name="printedside" onChange="this.form.submit();" style="width:200px;"  >
                                          
        <%  try{ Iterator i = inl.viewAllPrintedSideByProductCode(hsc.getCode()).iterator();
                                                        while(i.hasNext()){
                                                 Printedsidebean hps = (Printedsidebean) i.next();
        %>
        <option value="<%=hps.getPrintedsidename()%>"<%=request.getParameter("printedside") != null && request.getParameter("printedside").equalsIgnoreCase(hps.getPrintedsidename()) ? new String("selected") : new String("")%>><%=hps.getPrintedsidename()%></option>
        <%                                            }
...
<%}else { 
     ...
     String papertype = request.getParameter("papertype");
       String colorin  = request.getParameter("colorin");
     String printedside = request.getParameter("printedside");
        ...
        try{
           ...
           session.setAttribute("papertype", strims);
            ...
            session.setAttribute("printedside", printedside);
...
//size pages papertype
    ...
    sumb = inl.computeEnvelops(size, Quantity, session.getAttribute("ag").toString(), printedside);
          String gsf = new Integer(sumb).toString();
            ...
            %>
                      ...
                      <div class="pi-price" style="background-color:maroon; color:white">N<%=sumb%>.00</div><br/>
                          <a href="login.jsp?price=<%=gsf%>" class="btn btn-default add2cart">Add to cart</a>
         <%
          }else{
                session.setAttribute("price", hsc.getDefaultprice());
 ...
 <div class="pi-price" style="background-color:maroon; color:white">N<%=hsc.getDefaultprice()%>.00</div><br/>
  <a href="login.jsp?price=<%=hsc.getDefaultprice()%>"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ="btn btn-default add2cart">Add to cart</a>
