...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
  ...
  <%!
   ...
   if (username != null && username != "" && password != null && password != "" && request.getParameter("loginb") !=null) {
            ...
            mssg = inl.authenticatePassword2(username, password);
                    ...
                    if(mssg.equalsIgnoreCase(password)) { 
                              ...
                              Userbean ush = inl.viewSingleUserRec(username);
                               // msg = "";
                                ...
                                if (ush.getRole().equalsIgnoreCase("user")) {
                                    Customersbean sth = inl.viewSingleCustomer(username);
...
<div class="col-md-6 col-sm-6 additional-nav">
 ...
 <button type="submit" class="btn green pull-right" name="loginb">
			Login <i class="m-icon-swapright m-icon-white"></i>
                        ...
                        You do not have an Account with us?<a href="<%=psg%>?code=<%=code%>">  Click here</a> 
                      	</div>
									</div>
                                    </div>
                     </form>
