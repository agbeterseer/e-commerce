<%-- 
    Document   : viewQuantities
    Created on : Dec 18, 2015, 6:20:43 AM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addQuantity.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Quantities ..</td>
    </tr>
</table>
<table width="80%" border="0" cellspacing="0" cellpadding="0" id="results">
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Quantitybean hq = (Quantitybean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
  ...
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hq.getProductcode()%></td>
    <td><%=hq.getQty()%></td>
    <td><%=hq.getDescription()%></td>
    <td><%=hq.getProductcode()%></td>
    <td><a href="modifyQuantity.jsp?code=<%=hq.getQytId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hq.getQytId()%>">   </td>
    </tr>
   <%
	count++;
  }
