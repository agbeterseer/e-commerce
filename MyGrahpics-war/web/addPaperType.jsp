<%-- 
    Document   : addPaperType
    Created on : Dec 1, 2015, 2:37:15 PM
...
<html>
    <head>
        ...
        <title>Inspirational Images | add Paper Type</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
      ...
      <%
        ...
        try{
           inl.addPaperType("", papertype, description, productsid);
  ...
  <tr>
    <td ><a href="viewpapertypes.jsp">Previous</a></td>
     <td  >&nbsp;</td>
      <td  >&nbsp;</td>
 ...
 <div class="form-group"> <tr>
    <td>&nbsp;</td>
    <td><label class="col-md-3 control-label">Product ID</label></td>
    <td>
  ...
  <tr>
    ...
    <td width="46%">
      <input type="text" name="papertype" id="papertype" value="">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
