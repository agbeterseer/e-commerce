<%-- 
    Document   : addpolepocket
    Created on : Dec 1, 2015, 8:03:56 PM
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
                   ...
                   <% try{%> <%=inl.viewSingleStaff(session.getAttribute("username").toString()).getUsername()%>
                   <%
                   }catch(Exception ex){
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
       ...
       <%
        ...
        String polepocket = request.getParameter("polepocket");
        String status = request.getParameter("status");
        String description = request.getParameter("description");
        String startingprice = request.getParameter("Price");
//String style = "";
        try{
           msg = inl.addPolePocket("",polepocket,productsid, startingprice, "");
           //String id, String polepocketname, String productcode, String price, String description
  ...
  <tr>
    ...
    <td width="19%">SIZE</td>
    <td width="46%">
      <input type="text" name="polepocket" id="polepocket" value="">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
