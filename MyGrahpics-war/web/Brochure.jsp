    ...
    <div class="main">
      <div class="container">
       ...
       <li><a href="products.jsp"> Products</a></li><li class="active">  <%=inl.viewSingleSubcategory(code).getSubcategory()%></li>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <div class="row margin-bottom-30">
                <!-- BEGIN CAROUSEL -->
               <%
             //System.out.println("code inside startcalculate==" + codee);
        ...
        <%  try{ Iterator i = inl.viewBYPolePocketCODE(codee).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllPagesByProductid(codee).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllPaperTypeByProductName(codee).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllBindingProductId(codee).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllBindPlacement().iterator();
           ...
           %>
        <option value="<%=hbp.getBpName()%>"<%=request.getParameter("bindingplacement") != null && request.getParameter("bindingplacement").equalsIgnoreCase(hbp.getBpName()) ? new String("selected") : new String("")%>><%=hbp.getBpName()%></option>
        <%                                            }
                                                      }catch(Exception ex){
                                                System.out.println(ex.getMessage());
                                                      }
        ...
        <%  try{ Iterator i = inl.viewAllCoverPaperByProductId(codee).iterator();
                                                        while(i.hasNext()){
...
<%}else {  if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pad()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pads())){
        ...
        <%  try{            // ArrayList listi= new ArrayList();
                             Iterator i = inl.viewAllQuatityBydescription(codee).iterator();
...
//size pages papertype
    ...
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("pages")!=null){
       // System.out.println("pass this line now please===" + hq.getDescription());
          ...
          sumb = inl.viewSingleSize2(size, pages, Quantity, hsc.getDefaultprice(), hq.getDescription(), codee, binding);
