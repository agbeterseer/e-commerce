      ...
      <div class="container">
       ...
       <li><a href="products.jsp"> Products</a></li>
        ...
        <div class="row margin-bottom-40">
         ...
         <div class="item active"><a href="startcalculate.jsp?code=<%=hsc.getCode()%>"><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                          <p> <a href="startcalculate.jsp?code=<%=hsc.getCode()%>" style="color:white" > NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div></form>
                    <!-- Carousel nav -->
