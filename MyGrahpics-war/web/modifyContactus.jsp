<%-- 
    Document   : modifyContactus
    Created on : Nov 22, 2015, 10:24:04 AM
...
<html>
    <head>
        ...
        <title>Inspirational Images | Modify Contact Us</title>
...
<div class="page-container">
    ...
    try{
        if(request.getParameter("contactusb") !=null){
      //  String aboutus =request.getParameter("aboutus");
        ...
        msg = inl.modifyHerms(code,contactus, tellphone, states, fax, street, email, city, country,"");
        ...
        //String cus, String description, String status, String del, String street, String states, String city, String country
    ...
    <form name="form1" method="post" action="">
      <table width="70%" border="0" align="center">
        ...
        <tr>
          ...
          <td><input type="text" name="email" id="email"value="<%=hr.getEmail()%>"></td>
        </tr>
        <tr>
          <td><div align="right">Tell Phone</div></td>
          <td><input type="text" name="tellphone" id="tellphone" value="<%=hr.getProductcode()%>"></td>
        </tr>
        <tr>
          <td width="45%"><div align="right">Fax</div></td>
          <td width="55%"><input type="text" name="fax" id="fax" value="<%=hr.getFax()%>"></td>
        </tr>
        <tr>
          <td><div align="right">Office Address </div></td>
          <td><textarea name="contactus" id="contactus" cols="65" rows="11"><%=hr.getHermsname()%></textarea></td>
        </tr>
        <tr>
          <td><div align="right">city</div></td>
          <td><input type="text" name="city" id="city" value="<%=hr.getDesceiption()%>"></td>
        </tr>
        <tr>
          <td><div align="right">Street</div></td>
          <td><input type="text" name="street" id="street" value="<%=hr.getStatus()%>"></td>
        </tr>
        <tr>
          <td><div align="right">State</div></td>
          <td><input type="text" name="states" id="states" value="<%=hr.getPrice()%>"></td>
        </tr>
        <tr>
          <td><div align="right">Country</div></td>
          <td><input type="text" name="country" id="country" value="<%=hr.getOfficeaddress()%>"></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><input type="submit" name="contactusb" id="contactusb" value="Submit"></td>
        </tr>
      </table>
      </form>
      <%}catch(Exception ex){
