<%-- 
    Document   : uploadfile
    Created on : Dec 28, 2015, 6:07:26 AM
...
<title>Inspirational Images | Upload file</title>
...
<div style="padding-left:150px;"><h2><i>Bulk Booklets</i><br/>
<font size="+1" color="#FF0000"><i>starting from N3000</i></font>
</h2></div>
         <div class="item active"><a href="startcalculate.jsp?code=Booklets"><img alt="" src="pages/img/works/booklet.jpg"></a>
                  <div class="carousel-caption">
                          <p>Starting Price N3000</p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"  id="" enctype="multipart/form-data" action="uploadPicture" method="post" onsubmit="return validate(this);">
                <div class="form-body">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 padding-top-10">
            2016 © . ALL Rights Reserved. <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a>
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
