<%-- 
    Document   : previewYear
    Created on : Dec 9, 2015, 10:11:36 AM
...
<%
            try {
              ...
              String code = session.getAttribute("str").toString();
              //System.out.println("firstuuuuuu==" + code);

              psh = inl.viewSingleProductad(code);

             // ProductsserviceHelper viewSingleProductad(String p)
...
%>
  ...
  <tr>
    <td width="19%"><a href="<%=session.getAttribute("p").toString()%>">&lt;&lt;<strong>[Add Products]</strong></a></td>
    <td width="81%">&nbsp;</td>
  </tr>
  <tr>
    <td>Year</td>
    <td><%=psh.getProductsName()%></td>
  </tr>
  <tr>
    <td colspan="2"><img src="getBanner.jsp" alt="banner"/></td>
    </tr>
  <tr>
    <td>Logo</td>
    <td><img src="prelogo.jsp" alt="logo"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
