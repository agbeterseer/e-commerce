<%-- 
    Document   : addGrommet
    Created on : Dec 2, 2015, 7:18:04 PM
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        if(request.getParameter("button") !=null){
            String grommetname = request.getParameter("grommetname");
        String productsid = request.getParameter("productsid");
        
        String status = request.getParameter("qty");
        ...
        try{
           ...
           inl.addGrommet("",grommetname, productsid, startingprice, description, status, size, sizes , price2, "");
           //String id, String grommetname, String productcode, String price, String desceiption, String status, String sizes, String price2, String price3, String size1
           //String grommetname, String productcode, String price, String desceiption, String status, String sizes, String price2, String price3) {

           //String grommetname, String productcode, String price, String desceiption, String status
  ...
  <td>&nbsp;</td>
    <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><a href="viewGrommets.jsp">Previous</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="46%">
      <input type="text" name="grommetname" id="grommetname" value="<%=(request.getParameter("grommetname") != null) ? request.getParameter("grommetname") : new String("")%>">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Quantity</td>
    <td>
    <input type="text" name="qty" id="quantity"  value="<%=(request.getParameter("qty") != null) ? request.getParameter("qty") : new String("")%>">
   ...
   <tr>
    <td>&nbsp;</td>
    <td>Size</td>
      <td><input type="text" name="size" id="size"  value="<%=(request.getParameter("size") != null) ? request.getParameter("size") : new String("")%>"></td>
      <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Price</td>
    <td><input type="text" name="startingprice" id="startingprice"  value="<%=(request.getParameter("startingprice") != null) ? request.getParameter("startingprice") : new String("")%>"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Property</td>
      <td><input type="text" name="description" id="description"  value="<%=(request.getParameter("description") != null) ? request.getParameter("description") : new String("")%>"></td>
      <td>&nbsp;</td>
   ...
   <tr>
    <td>&nbsp;</td>
    <td>Sizes</td>
      <td><input type="text" name="sizes" id="sizes" value="<%=(request.getParameter("sizes") != null) ? request.getParameter("sizes") : new String("")%>"></td>
      <td>&nbsp;</td>
   ...
   <tr>
    <td>&nbsp;</td>
    <td>Price2</td>
    <td><input type="text" name="price2" id="price2"  value="<%=(request.getParameter("price2") != null) ? request.getParameter("price2") : new String("")%>"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
