<%-- 
    Document   : modifyBindingPlacement
    Created on : Dec 4, 2015, 3:34:33 PM
...
<html>
    <head>
        ...
        <title>modify Binding Placement</title>
...
<div class="page-container">
   ...
   try{
        ...
        String startingprice = request.getParameter("startingprice");
           ...
           msg = inl.modifyBindingPlacement(code, nlocation, productsid, startingprice, status);
       ...
       Bindpalcementbean hbp = inl.viewSingleBindPlacement(code);
										...
										* </span></label>
										<div class="col-md-9">
											<select class="form-control" name="productsid">
                                                 <option value=" <%=hbp.getProductid()%>"> <%=hbp.getProductid()%></option>
  ...
  <tr>
    <td width="23%">&nbsp;</td>
    <td width="19%">Binding Placement</td>
    <td width="46%">
      <input type="text" name="nlocation" id="nlocation" value="<%=hbp.getBpName()%>">
    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><label>
      <select name="status" id="status">
          <option value="<%=hbp.getStatus()%>"><%=hbp.getStatus()%></option>
  ...
  <tr>
    ...
    <td><input type="text" name="startingprice" id="startingprice" value="<%=hbp.getPrice()%>"> </td>
    <td>&nbsp;</td>
  </tr>
