...
<html>
    <head>
        ...
        <title>Inspiration | Product</title>
...
<%
         ...
         <div class="item active"><a href="catcal.jsp?code=<%=hsc.getCode()%>"><img alt="" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
         ...
         <%}}catch(Exception ex){System.out.println();} session.setAttribute("ag", hsc.getCode()); %>
               ...
               <font  size="+2" color="#FF0000">  <p> <strong>It's easy to get started now!</strong></p></font>
                ...
                <font color="blue"> <strong> @ +234 8095434402, 234 8095434425.</strong> </font> for assistance
                  <br>
