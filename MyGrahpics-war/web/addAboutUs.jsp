<%-- 
    Document   : addAboutUs
    Created on : Nov 22, 2015, 6:10:49 AM
...
<html>
    <head>
        ...
        <title>Inspiration Images | AboutUs</title>
...
//String cardslotname, String productcode, String price, String description, String status
        inl.addCardSlot("",aboutus, ourtechnology, ourpeople, details, visionmission,ourvision);
    ...
    <form name="form1" method="post" action="" onsubmit="return validate(this);">
     <table width="70%" border="0" align="center">
        ...
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="aboutus" id="aboutus" cols="65" rows="11"> </textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="details" id="details" cols="65" rows="11"> </textarea></td>
        </tr>
           <tr>
           ...
           <tr>
          <td>&nbsp;</td>
          <td><textarea name="visionmission" id="visionmission" cols="65" rows="11"> </textarea></td>
        </tr>
           <tr>
           ...
           <tr>
             <td>&nbsp;</td>
             <td><textarea name="ourtechnology" id="ourtechnology" cols="65" rows="11"> </textarea></td>
           </tr>
           <tr>
             <td>Our People</td>
             <td>&nbsp;</td>
           ...
           <tr>
             <td>&nbsp;</td>
             <td><textarea name="ourpeople" id="ourpeople" cols="65" rows="11"> </textarea></td>
           </tr>
        <tr>
          <td>
            Our Vision</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><textarea name="ourvision" id="ourvision" cols="65" rows="11"> </textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
