<%-- 
    Document   : viewcoverpapers
    Created on : Dec 4, 2015, 2:37:00 PM
...
<html>
    <head>
        ...
        <title>Inspirational Images |view coverpapers</title>
	...
	<div class="page-content-wrapper">
      ...
      <%
       ...
       try{
        ...
        <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addCoverpaper.jsp">Add Item</a></td>
        </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Cover Paper ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Coverpaperbean cph = (Coverpaperbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                       // session.setAttribute("p", "viewcoverpapers.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=cph.getDescription()%></td>
    <td><%=cph.getCpName()%></td>
    <td><%=cph.getDel()%></td>
    <td><%=cph.getStatus()%></td>
    <td><a href="modifyCoverpaper.jsp?code=<%=cph.getCpId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=cph.getCpId()%>">   </td>
    </tr>
   <%
	count++;
  }
