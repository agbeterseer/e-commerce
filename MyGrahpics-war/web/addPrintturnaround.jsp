<%-- 
    Document   : addPrintturnaround
    Created on : Nov 29, 2015, 9:05:33 AM
...
<html>
    <head>
        ...
        <title>add Print turnaround</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
     ...
     <%
        ...
        try{
                inl.addPrintturarround("",printturnaround,startingprice,productsid);
//                /String id, String printType, String price, String productid
                response.sendRedirect("viewPrintTurnarounds.jsp"); 
                //String printType, String status, String del, String price, String productid
                style = msg;
  ...
  <tr>
    <td width="34%">&nbsp;</td>
    <td width="18%">Print Turnaround</td>
    <td width="27%"><label>
      <input type="text" name="printturnaround" id="printturnaround" value="">
    </label></td>
    <td width="21%">&nbsp;</td>
  </tr>
  <tr>
