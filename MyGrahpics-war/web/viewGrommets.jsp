<%-- 
    Document   : viewGrommets
    Created on : Dec 2, 2015, 7:20:22 PM
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addGrommet.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Grommets ..</td>
    </tr>
</table>
<table width="80%" border="0" cellspacing="0" cellpadding="0" id="results">
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Grommetbean hg = (Grommetbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
  ...
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hg.getProductcode()%></td>
    <td><%=hg.getGrommetname()%></td>
    <td><%=hg.getStatus()%></td>
    <td><%=hg.getPrice()%></td>
    <td><a href="modifyGrommet.jsp?code=<%=hg.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hg.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
