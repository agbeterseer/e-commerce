...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
   ...
   <%@include file="lookupa.jsp" %>
    <%
//String code = "";
//String codee = "SUB/40494";
       try{
        String code = request.getParameter("code"); 
        String flyer = request.getParameter("codeo");
   ...
   <div class="header">
    ...
    <div class="main">
      <div class="container">
          ...
          <div class="col-md-12 col-sm-12">
              ...
              hsc = inl.viewSingleSubcategory(code);
                ...
                <div class="col-md-5 front-carousel" >
                  <div class="carousel slide" id="myCarousel">
                    ...
                    <div class="item active"> <img alt="Inspirational" src="displayPic?code=<%=flyer%>">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post"  onsubmit="return validate(this);">
                  <% if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBooklets()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getShortRunBooks()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBrochure()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCataloge()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCalender()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayers()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getFlayer())|| hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGreeting_Cards()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLebels_Stickers())|| hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLUAGAGE_AGS()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLebels_Stickers()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEercise_book()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pads()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLetterhead_Stattionary()) ){ %>
                <div class="form-body">
       ...
       <%  try{ Iterator i = inl.viewBYPolePocketCODE(hsc.getCode()).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllPagesByProductid(hsc.getCode()).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllPaperTypeByProductName(hsc.getCode()).iterator();
                                                        while(i.hasNext()){
...
//size pages papertype
    ...
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("pages")!=null){
        //System.out.println("pass this line now please===" + hq.getDescription());
          ...
          sumb = inl.computFlayers(code, pages,Quantity, papertype, size);
          //(String productcode, String pages, String qty, String papertype, String size1)
//String size, String qty, String papertype, String pages, String productcode
          String gsf = new Integer(sumb).toString();
            ...
            %>
                      ...
                      <div class="pi-price" style="background-color:maroon; color:white">N<%=sumb%>.00</div><br/>
                          <a href="shop-shopping-cart.jsp?code=<%=code%>" class="btn btn-default add2cart">Add to cart</a>
         <%
          }else{
