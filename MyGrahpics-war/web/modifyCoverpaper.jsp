<%-- 
    Document   : modifyCoverpaper
    Created on : Dec 4, 2015, 2:44:22 PM
...
<html>
    <head>
        ...
        <title>Inspirational Images | modify Cover paper</title>
...
<div class="page-container">
   ...
   try{
        ...
        String startingprice = request.getParameter("startingprice");
           ...
           inl.modifyCoverPaper(code, nlocation, startingprice, productsid);
           
           response.sendRedirect("viewcoverpapers.jsp");
      ...
      Coverpaperbean cph = inl.viewSingleCoverPaper(code);
										...
										* </span></label>
										<div class="col-md-9">
											<select class="form-control" name="productsid">
                                                 <option value="<%=cph.getDescription()%> "><%=cph.getDescription()%></option>
  ...
  <tr>
    <td width="23%">&nbsp;</td>
    <td width="19%">Cover Paper</td>
    <td width="46%">
      <input type="text" name="nlocation" id="nlocation" value="<%=cph.getCpName()%>">
    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><label>
      <select name="status" id="status">
          <option value="<%=cph.getDel()%>"><%=cph.getDel()%></option>
  ...
  <tr>
    ...
    <td><input type="text" name="startingprice" id="startingprice" value="<%=cph.getStatus()%>"> </td>
    <td>&nbsp;</td>
  </tr>
