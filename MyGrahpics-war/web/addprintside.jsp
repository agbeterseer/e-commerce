<%-- 
    Document   : addprintside
    Created on : Dec 1, 2015, 7:15:52 PM
...
<div class="page-container">
    ...
    <%
        ...
        try{
           msg = inl.addPrintedSide(printedside,productsid, startingprice, description);
//String printedsidename, String productid, String price, String description
  ...
  <td  >&nbsp;</td>
    <td  >&nbsp;</td>
      <td  >&nbsp;</td>
      <td  ><a href="viewprintedsides.jsp">Previous</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="46%">
      <input type="text" name="printedside" id="printedside" value="">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
