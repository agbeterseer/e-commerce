<%-- 
    Document   : modifypage
    Created on : Dec 1, 2015, 3:34:21 PM
...
<html>
    <head>
      ...
      <title>Inspiration Images |Page</title>
   ...
   try{
      ...
      Pagestabbean pth = inl.viewSinglePages(code);
        ...
        %>
                                            ...
                                            <div class="form-group">
                                             <label class="col-md-3 control-label">Page Number<span class="required">
										* </span></label>
                                                <div class="col-md-9">
                                                  <input type="text" name="pagenumber" id="pagenumber" placeholder="Enter startingprice" value="<%=pth.getPageNumber()%>">
                                                </div>
                                                </div>
                                                <div class="form-group">
                                             <label class="col-md-3 control-label">Starting Price</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter startingprice" name="startingprice" value="<%=pth.getPrice()%>">
                                                </div>
                                                </div>
                                                         <div class="form-group">
                                             <label class="col-md-3 control-label">Status</label>
                     <div class="col-md-9"><select name="status" id="status" class="form-control">
          <option value="<%=pth.getStatus()%> "> <%=pth.getStatus()%></option>
