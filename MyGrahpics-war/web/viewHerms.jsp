<%-- 
    Document   : viewHerms
    Created on : Dec 2, 2015, 6:56:29 PM
...
<html>
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addHerms.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Herms ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Hermsbean hr = (Hermsbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        //session.setAttribute("p", "viewHerms.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hr.getProductcode()%></td>
    <td><%=hr.getHermsname()%></td>
    <td><%=hr.getStatus()%></td>
    <td><%=hr.getPrice()%></td>
    <td><a href="modifyHerms.jsp?code=<%=hr.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
