<%-- 
    Document   : viewIteriorColors
    Created on : Dec 2, 2015, 6:04:04 PM
...
<html>
    <head>
        ...
        <title>view Iterior Colors</title>
...
<div class="page-container">
  ...
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addInteriorColor.jsp">Add Item</a></td>
  </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Interior Colors ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                       Interiorcolorbean hc = (Interiorcolorbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        //session.setAttribute("p", "viewIteriorColors.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hc.getProductcode()%></td>
    <td><%=hc.getInteriorcolorname()%></td>
    <td><%=hc.getStatus()%></td>
    <td><%=hc.getPrice()%></td>
    <td><a href="modifyInteriorcolor.jsp?code=<%=hc.getId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hc.getId()%>">   </td>
    </tr>
   <%
	count++;
  }
