...
<%
         ...
         <div class="item active"><a href="calculcat.jsp?code=<%=hsc.getCode()%>"><img alt="Inspirational" src="displayPicture?code=<%=hsc.getCode()%>" ></a>
                  <div class="carousel-caption">
                          <p ><a href="calculcat.jsp?code=<%=hsc.getCode()%>" style="color:white"> NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
         ...
         <%}}catch(Exception ex){System.out.println();} session.setAttribute("ag", hsc.getCode()); %>
                ...
                <div class="col-md-7">
                  <h2> </h2>
                 <font color="#FF0000">  <p> <strong>It's easy to get started now!</strong></p></font>
