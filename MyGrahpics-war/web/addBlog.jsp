<%--
    Document   : addBlog
    Created on : Apr 6, 2016, 2:20:43 AM
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
      ...
      <div class="portlet-body form">
        ...
        <form action="uploadBlogPic" method="post" class="form-horizontal" role="form" onsubmit="return validate(this);" enctype="multipart/form-data">
             <table width="70%"> <tr>
            <td>
            <div class="form-body">
                                    ...
                                    <label class="col-md-3 control-label">Title </label>
										<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter Title" name="blogtitle">
										</div>
                                        </div>
                                                  <div class="form-group">
                                             <label class="col-md-3 control-label">Details</label>
                                                <div class="col-md-9">
                                                <textarea name="details" class="form-control" id="details" cols="100" rows="50"></textarea>
