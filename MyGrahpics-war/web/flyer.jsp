<%-- 
    Document   : flyer
    Created on : May 12, 2016, 10:35:27 AM
            ...
            <div class="row margin-bottom-30">
              ...
              Iterator i = inl.viewAllSubCategorisProductID(code).iterator();
                ...
                while(i.hasNext()){
                 ...
                 Iterator ivi = inl.viewAlProductsImageslByProductCode(hsc.getProductId()).iterator();
                 while(ivi.hasNext()){
                   Productimagesbean  pi = (Productimagesbean) ivi.next();
                 
                 session.setAttribute("flyer", pi.getCode());
                 //
        // System.out.println("DisplayPic==="+pi.getProductcode());
                  %>
                ...
                <div class="col-md-5 front-carousel" >
                    ...
                    <font size="+1" color="#FF0000"><i>starting from N <%=pi.getStartprice()%></i></font>
            </h2> </div>
         <div class="item active"><a href="flyers.jsp?code=<%=hsc.getCode()%>&&codeo=<%=pi.getCode()%>"><img alt="" src="displayPic?code=<%=pi.getCode()%>" ></a>
                  <div class="carousel-caption">
                          <p> <a href="flyers.jsp?code=<%=hsc.getCode()%>&&codeo=<%=pi.getCode()%>" style="color:white" > NEXT>>>> Pricing & Order Option</a></p>
                        </div>
                      </div>
                    </div></form>
                    <!-- Carousel nav -->
