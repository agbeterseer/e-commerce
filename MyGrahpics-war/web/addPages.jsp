<%-- 
    Document   : addPages
    Created on : Dec 1, 2015, 3:30:44 PM
...
<%
        ...
        try{
           ...
           inl.addPages("",pagenumber, "", startingprice, productsid, pagename);
            msg= "DONE SUCCSSFULY";
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        %>
										...
										* </span></label>
                                                <div class="col-md-9">
                                                    <input type="text" name="pagenumber" id="pagenumber" placeholder="Enter Page Number" value="">
										...
										* </span></label>
                                                <div class="col-md-9">
                                                    <input type="text" name="pagename" id="pagename" placeholder="Enter Page Name" value="">
