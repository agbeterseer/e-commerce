<%-- 
    Document   : viewBindings
    Created on : Dec 4, 2015, 3:50:32 PM
	...
	<div class="page-content-wrapper">
      ...
      <%
       ...
       try{
        ...
        <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addBinding.jsp">Add Item</a></td>
        </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Binding ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                      Bindingbean bh = (Bindingbean)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                       // session.setAttribute("p", "viewBindings.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=bh.getProductid()%></td>
    <td><%=bh.getBindingName()%></td>
    <td><%=bh.getStatus()%></td>
    <td><%=bh.getPrice()%></td>
    <td><a href="modifyBinding.jsp?code=<%=bh.getBindingId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=bh.getBindingId()%>">   </td>
    </tr>
   <%
	count++;
  }
