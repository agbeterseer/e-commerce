<%-- 
    Document   : viewBlindPlacements
    Created on : Dec 4, 2015, 3:06:50 PM
...
<html>
    <head>
        ...
        <title>Inspirational Images | view Blind Placements</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
      ...
      <%
       ...
       try{
            list = inl.viewAllBlindingPlacement();
        }catch(Exception ex){
        ...
        <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"> <a href="addBindingPlacement.jsp">Add Item</a></td>
        </tr>
</table>

<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="17" class="tableheader" >..::All Binding Placement ..</td>
    </tr>
</table>
  ...
  <tr>
    ...
    <%
      ...
      <%
                ...
                while(it.hasNext()){
                        h++;
                        hbp = (HelpBindPlacement)it.next();
			     if(count%2==0){
				 style = "even";
				 }else{
				 style = "odd";
				 }
                        //session.setAttribute("p", "viewBlindPlacements.jsp");
  %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><%=hbp.getProductid()%></td>
    <td><%=hbp.getBpName()%></td>
    <td><%=hbp.getStatus()%></td>
    <td><%=hbp.getPrice()%></td>
    <td><a href=".jsp?code=<%=hbp.getBpId()%>"><img src="img/edit.png" alt="no image"></a></td>
    <td>
      <input type="checkbox" name="remove" value="<%=hbp.getBpId()%>">   </td>
    </tr>
   <%
	count++;
  }
