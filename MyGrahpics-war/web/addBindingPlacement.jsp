<%-- 
    Document   : addBindingPlacement
    Created on : Dec 4, 2015, 3:04:41 PM
...
<html>
    <head>
        ...
        <title>Inspiration Images |Binding Placement</title>
                ...
                <div class="page-content">
                    <%
                        if (request.getParameter("button") != null) {
                            ...
                            try {
                                inl.addBindPlacement("", nlocation, status, startingprice, productsid);
                                //String bpId, String bpName, String description, String price, String productid)
                                response.sendRedirect("viewBlindPlacements.jsp");
                    ...
                    <div class="portlet-body form">
                        <form action="" method="post" class="form-horizontal" role="form" onsubmit="return validate(this);"> 
                            <%=msg%>
                            <div class="form-body"><a href="viewBlindPlacements.jsp">Previous</a>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="productsid">
                                            <option value=" "> </option>
                                            <%  try {
                                                    Iterator i = inl.viewAllSubCategoris().iterator();
                                                    while (i.hasNext()) {
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Binding Placement<span class="required">
                                            * </span></label>
                                    <div class="col-md-9">
                                        <input type="text" name="nlocation" id="Binding Placement" placeholder="Enter Binding Placement" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Enter startingprice" name="startingprice" value="">
                                    </div>
                                </div>
                                <div class="form-group">
