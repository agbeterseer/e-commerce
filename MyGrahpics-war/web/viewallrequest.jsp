<%-- 
    ...
    Created on : Dec 29, 2015, 7:34:27 AM
...
<div class="portlet box blue">
    ...
    <td height="20" colspan="6" bgcolor="#FF9966" >No Records Found !</td>
     ...
     <%
      ...
      <%
                ...
                while(it.hasNext()){
                h++;
                Requestprintbean rph = (Requestprintbean)it.next();
		 if(count % 2 == 0){
		      style = "even";
                } else {
                style = "odd";
  ...
  %>
                           ...
                           <td>
								...
								<td>
									<input type="checkbox" name="remove" value="<%=rph.getRpId()%>">
								</td>
							</tr>
                             <%
                        count++;
