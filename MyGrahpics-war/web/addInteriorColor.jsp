<%-- 
    Document   : addInteriorColor
    Created on : Dec 2, 2015, 6:01:22 PM
...
<html>
    <head>
        ...
        <title>add Interior Color</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
       ...
       <%
        ...
        String interiorcolorname = request.getParameter("interiorcolorname");
        String status = request.getParameter("status");
        String description = request.getParameter("description");
        String startingprice = request.getParameter("startingprice");

        try{
         msg = inl.addInteriorColor("",interiorcolorname,productsid, startingprice, description);
  ...
  <td>&nbsp;</td>
    <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><a href="viewIteriorColors.jsp">Previous</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="23%">&nbsp;</td>
    <td width="19%"> Color</td>
    <td width="46%">
      <input type="text" name="interiorcolorname" id="interiorcolorname" value="">    </td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
