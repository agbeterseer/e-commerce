    ...
    <div class="main">
      <div class="container">
       ...
       <li><a href="products.jsp"> Products</a></li><li class="active">  <%=inl.viewSingleSubcategory(code).getSubcategory()%></li>
          ...
          <div class="item active"> <img alt="" src="displayPicture?code=<%=hsc.getCode()%>">
            ...
            <div class="portlet-body form">
              <form class="form-horizontal"   action=""  method="post"  onsubmit="return validate(this);">
                  <% if (hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBooklets()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getShortRunBooks()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getBrochure()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCataloge()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getCalender()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getGreeting_Cards()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLUAGAGE_AGS()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLebels_Stickers()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getEercise_book()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getNote_pads()) || hsc.getProductId().equalsIgnoreCase(Utill.CONFIG.getLetterhead_Stattionary()) ){ %>
                <div class="form-body">
        ...
        <%  try{ Iterator i = inl.viewAllBindingProductId(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
        ...
        <%  try{ Iterator i = inl.viewAllCoverPaperByProductId(session.getAttribute("ag").toString()).iterator();
                                                        while(i.hasNext()){
...
//size pages papertype
       ...
       float total = 0.0F;
       int sumb = 0;
    if(request.getParameter("size")!=null || request.getParameter("Quantity")!=null || request.getParameter("coverpaper")!=null){
       //System.out.println("pass this line now please===" + hq.getDescription());
        ...
        sumb = inl.computeLetterHead(size, coverpaper, Quantity, session.getAttribute("ag").toString());
        //String size, String papertype, String Quantity, String productcode
