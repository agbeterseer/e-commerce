<%-- 
    Document   : seeAllData
    Created on : Nov 27, 2015, 6:14:09 PM
...
<div class="page-container">
   ...
   <%
       ...
       String[] pk = request.getParameterValues("remove");
        ...
        //int[] pk =Integer.parseInt(xi);
            ...
            try{
               ...
               inl.removeInitializedProduct(pk[i]);
      ...
      List list = inl.viewAllInitialProducts();
...
<table width="80%" border="0"  cellpadding="0" cellspacing="0" id="results">
  <tr  class="art-PostMetadataHeader" >
    <td width="26%" height="31" ><strong>..:: list of Products..</strong></td>
    <td width="17%">&nbsp;</td>
    <td width="45%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
      <td width="6%">&nbsp;</td>
  ...
  <tr   class="outer_table">
    <td height="29"><strong>Product Name</strong></td>
  ...
  <tr>
    <td height="20" colspan="5" bgcolor="#FF9966" >No Records Found !</td>
    </tr>
     <%
                }else{
      ...
      <%
                ...
                while(l.hasNext()){
                h++;
               Initializeprodutsbean hlp  =(Initializeprodutsbean)l.next();
		 if(count % 2 == 0){
		      style = "even";
                } else {
                style = "odd";
  ...
  %>
  <tr class="<%=style%>">
    <td height="26" class="tab_lebel"><%=hlp.getProductName()%></td>
    <td><%=hlp.getDefaultpage()%></td>
    <td><%=hlp.getProductDefaultPrice()%></td>
    <td><%=hlp.getProductStatus()%></td>
   
    <td><a href="modifyInitialProducts.jsp?code=<%=hlp.getProductName()%>">[modify]</a>
   </td>
    <td><input type="checkbox" name="remove" value="<%=hlp.getProductName()%>"></td>
  </tr>
    <%
  count++;
   }
