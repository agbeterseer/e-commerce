...
<body class="corporate">
     <div class="pre-header" style="margin-top:19px;">
        <div class="container">
            <div class="row">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <div class="row margin-bottom-30">
                ...
                <%
               try{
                  Iterator ioi = inl.viewAllSubCategorisFolding("1").iterator();
                  while(ioi.hasNext()){
                 hsc = (Subcategorybean) ioi.next();
                 session.setAttribute("ag", hsc.getCode());
                 %>
                <div class="col-md-5 front-carousel" >
                  <div class="carousel slide" id="myCarousel">
                    <!-- Carousel items -->
                     <form action="" name="form1" id="form1"enctype="multipart/form-data" method="get">
         ...
         <div class="item active"><a href="catcal.jsp?code=<%=hsc.getCode()%>"></a>
                  <div class="carousel-caption">  <input name="code" type="hidden" id="code" value="<%=hsc.getCode()%>">
                         <p><a href="catcal.jsp?code=<%=hsc.getCode()%>" style="color:white"> NEXT>>>> Pricing & Order Option </a></p>
                        </div>
                      </div>
                    </div>
                    </form>
         ...
         <%}}catch(Exception ex){System.out.println();} session.setAttribute("ag", hsc.getCode()); %>
               ...
               <font  size="+2" color="#FF0000">  <p> <strong>It's easy to get started now!</strong></p></font>
                  <font  size="+2" style="color:#000000"><p><strong> Need help ordering? Contact us now.</strong><br/></font>
                <font color="blue"> <strong> @ +234 80954334402, 234 8095434425.</strong> </font> for assistance
                  <br>
