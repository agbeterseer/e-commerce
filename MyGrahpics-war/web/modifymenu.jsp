<%-- 
    Document   : modifymenu
    Created on : Dec 5, 2015, 11:40:18 PM
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="viewMenus.jsp">
							Menu</a>
						</li>
                        <li>
							<a href="viewSubMenus.jsp">
							Submenu</a>
						</li>
				</ul>
				</li>
        ...
        <form action="" method="get" class="form-horizontal" role="form">
            <div class="form-body">
                                    ...
                                    <label class="col-md-3 control-label">Menu  </label>
										<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter menuname" name="menuname" value=" ">
										</div>
                                        </div>
                                             ...
                                             <label class="col-md-3 control-label">Link</label>
                                                <div class="col-md-9">
        										<input type="text" class="form-control" placeholder="Enter link" name="linkz" value=" ">
                                                </div>
                                                </div>
 <div class="form-group">
