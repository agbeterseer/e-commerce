<%-- 
    ...
    Created on : Nov 29, 2015, 9:04:45 AM
...
<html>
    <head>
        ...
        <title>Inspirational Images | add Quantity</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
       ...
       <%
        ...
        if(request.getParameter("button") !=null && productsid !=null && productsid !="" && startingprice !=null && startingprice !="" && quantity !=null && quantity !=""){
       

        try{
                inl.addQuantity("",quantity,startingprice,productsid);
                msg = "DONE SUCCESSFULY";
                // String qytId, String qty, String description, String productcode
                response.sendRedirect("viewQuantities.jsp");
                //(String qty, String description, String status, String del, String productcode
                style = msg;
